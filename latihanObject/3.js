 ...
 function evaluatePassenger(passenger) {
   ...
   if (passenger.temperature > 35 && travelSuspect == true) {
     status = 'Suspect';
   } else if (passenger.temperature <= 35 && travelSuspect == false) {
     status = 'Healthy';
   } else if (passenger.temperature <= 35 && travelSuspect == true) {
     status = 'Potenstial Carrier';
   } else if (passenger.temperature > 35 && travelSuspect == false) {
     status = 'Sick';
   }
